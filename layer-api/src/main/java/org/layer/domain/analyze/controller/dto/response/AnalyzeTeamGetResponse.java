...
public record AnalyzeTeamGetResponse(
	int scoreOne,
	int scoreTwo,
	int scoreThree,
	int scoreFour,
	...
	public static AnalyzeTeamGetResponse of(Analyze analyze) {
		...
		return new AnalyzeTeamGetResponse(analyze.getScoreOne(), analyze.getScoreTwo(),
