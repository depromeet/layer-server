...
public interface AdminTemplateRepository extends JpaRepository<AdminTemplateRecommendation, Long> {
	...
	@Query("SELECT new org.layer.admin.template.controller.dto.TemplateRecommendedRatioResponse(r.formTag, COUNT(r)) " +
		"FROM AdminTemplateRecommendation r " +
		"GROUP BY r.formTag")
	List<TemplateRecommendedRatioResponse> countByFormTag();
}
